...
The goal is to have a single repo for the entire C language where you can see all the pure, standard version of C and develop your program that wouldn't create problems between different platforms. 
